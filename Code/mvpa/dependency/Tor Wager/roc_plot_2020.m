function ROC = roc_plot_2020(input_values, binary_outcome, varargin)
%%
%--------------------------------------------------------------------------
...
[dummy, tpr, fpr, auc, c_bias] = roc_calc_2020(input_values, binary_outcome, thr);
...
switch plotmethod
    case 'deciles'
        ...
        [dummy, plottpr, plotfpr] = roc_calc_2020(input_values, binary_outcome, plotthr);
        plotsymbol = 'o';
        linewid = 2;
...
if doboot
    ...
    [ci, names] = roc_boot_2020(input_values, binary_outcome, ROC.class_threshold, 0);
